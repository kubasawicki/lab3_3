...
import edu.iis.mto.time.example.TimeSource;
...
public class Order {
    ...
    public void confirm() {
        ...
        int hoursElapsedAfterSubmittion = Hours.hoursBetween( subbmitionDate, new DateTime( time.getCurrentMillis() ) ).getHours();
